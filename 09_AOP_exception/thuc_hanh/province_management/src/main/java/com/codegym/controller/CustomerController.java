...
public class CustomerController {
    ...
    public Page<Province> provinces(Pageable pageable) throws Exception {
    ...
    public ModelAndView listCustomers(@PageableDefault(value = 5)Pageable pageable) throws Exception {
